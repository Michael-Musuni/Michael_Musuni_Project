...
@Component({
  selector: 'app-revenues-statement',
  templateUrl: './revenues-statement.component.html',
  styleUrls: ['./revenues-statement.component.sass']
})
export class RevenuesStatementComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.billing. revenuesStatement(formattedFromDate,  formattedToDate).subscribe(
      (response: Blob) => {
        this.loading = false; // Stop loading
        const url = window.URL.createObjectURL(response);
        const a = document.createElement('a');
        a.href = url;
        a.download = 'revenueReport.pdf';
