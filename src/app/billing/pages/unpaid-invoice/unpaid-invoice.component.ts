...
@Component({
  selector: 'app-unpaid-invoice',
  templateUrl: './unpaid-invoice.component.html',
  styleUrls: ['./unpaid-invoice.component.sass']
})
export class UnpaidInvoiceComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.billing. unpaidStatement(formattedFromDate,  formattedToDate).subscribe(
      (response: Blob) => {
        this.loading = false; // Stop loading
        const url = window.URL.createObjectURL(response);
        const a = document.createElement('a');
        a.href = url;
        a.download = 'UnpaidInvoiceReport.pdf';
