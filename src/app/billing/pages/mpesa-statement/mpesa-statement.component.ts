...
@Component({
  selector: 'app-mpesa-statement',
  templateUrl: './mpesa-statement.component.html',
  styleUrls: ['./mpesa-statement.component.sass']
})
export class MpesaStatementComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.billing. mpesaStatement(formattedFromDate,  formattedToDate).subscribe(
      (response: Blob) => {
        this.loading = false; // Stop loading
        const url = window.URL.createObjectURL(response);
        const a = document.createElement('a');
        a.href = url;
        a.download = 'M-pesaPaymentReport.pdf';
